...
- 25 testów automatycznych: 5 logiki cenowej, 10 zachowania treści, materiałów, danych i SEO oraz 10 przebiegu formularza i ikon. Nowe testy sprawdzają brak żądań przed potwierdzeniem, walidację, payload z wiadomością i parametrami, reset, brak podwójnej wysyłki, błędy serwera i tryb podglądu. Żądania sieciowe w testach są atrapami. Oryginalne obrazy i logotypy sprawdzane przez SHA-256.
