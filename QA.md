...
- Pusty formularz pokazuje błędy przy imieniu, telefonie, e-mailu i zgodzie; brak wyniku.
...
- 15 testów automatycznych: 5 logiki kalkulatora i 10 zachowania treści, materiałów, danych i SEO. Oryginalne obrazy i logotypy sprawdzane przez SHA-256.
