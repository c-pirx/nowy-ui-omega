...
test("WordPress theme is native, self-contained and keeps the approved sections", async () => {
  ...
  assert.match(functions, /woocommerce_account_dashboard'.*omega_account_dashboard/);
  assert.match(functions, /woocommerce_before_customer_login_form'.*omega_account_lead/);
